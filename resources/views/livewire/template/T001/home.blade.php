<div>
    ...
    <div class="container p-3">
        ...
        <a href="#" class="btn btn-outline-light" style="border-radius: 20px">see My Resume</a>
        <br>
        <br>
        <br>
        <span>
